              ...
              child: Column(
                ...
                children: [
                  ...
                  CardTextFormFiled(
                   ...
                   BlocProvider.of<AddressCubit>(context)
                          .addDataToModel(details: location);
                    },
                    inputFormatters: const [],
                  ),
                  GestureDetector(
                    onTap: () => context
                      ...
                      const MapView(),
                        ...
                        .then((value) async {
                   BlocProvider.of<AddressCubit>(context)
                          .addDataToModel(latitude: value!.latitude.toString(), longitude: value.longitude.toString());
                    }),
                    child: Image.asset(
