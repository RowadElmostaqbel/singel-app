...
class SubCategoryListView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      context.read<CategoriesCubit>().fetcSubCategories(categoryId.toString());
      return null;
    }, [categoryId]);
          ...
          itemBuilder: (context, index) {
            return selectedIndex.value == index
                ...
                : GestureDetector(
                    ...
                    child: const UnSelecetedSubCategoryListItem(),
                  );
          },
        );
      },
        ...
        children: [
          ...
          Align(
            ...
            child: SizedBox(
              ...
              width: 80,
              child: Image.asset(
                Assets.assetsImagesChickenBurger,
              ),
            ),
          ),
        ],
...
class SelecetedSubCategoryListItem extends StatelessWidget {
  const SelecetedSubCategoryListItem({
    super.key,
  });
